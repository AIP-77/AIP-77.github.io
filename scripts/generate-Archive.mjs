...
const GID = '46987733'; // ← ЗАМЕНИТЕ на реальный GID вашего листа с данными!
const OUTPUT_PATH = './archive.json'; //название фаила
...
function buildFullDataArchveJson(parsed) {
...
const json = buildFullDataArchveJson(parsed);
...
console.error('❌ Ошибка при генерации archive.json:', err.message);
process.exit(1);
}
}
